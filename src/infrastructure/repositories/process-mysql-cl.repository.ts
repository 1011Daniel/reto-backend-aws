...
export class MysqlClRepository extends AppointmentMysqlRepository{

    // Para poder conectar con la rds, se debe manejar las credenciales en Secret Manager
    // Se plantea una estructura para conexion
    // Esquema secret "rds/mysql_cl"
    //   {
    //   "host": "mysql-cl.xxxx.rds.amazonaws.com",
    //   "username": "admin",
    ...
    //     new GetSecretValueCommand({ SecretId: "rds/mysql_cl" })
    //     );
    ...
    async save(appointment:Appointment):Promise<void>{
       ...
       // await connection.execute(`INSERT INTO appointment VALUES (?, ?, ?, ?, ?,?)`,[]);
        ...
        console.log("Insertando Appointment en mysql CL",appointment);
    }
}